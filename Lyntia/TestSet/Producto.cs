...
namespace Lyntia.TestSet
{
    ...
    class Producto
    {
        ...
        public void CRM_APR0001_añadir_producto()
        {
            ...
            commonActions.acceder_A_GestionCliente();//Acceso al modulo de Gestion de Cliente(Aplicaciones)
...
            commonCondition.validar_Acceso_A_GestionCliente();//Acceso correcto             
            ...
            ofertaCondition.validar_SeleccionOfertaBorrador();//se realizan comprobaciones

            //Paso 5
            productoActions.Agregar_Producto_tipo_circuito_de_capacidad(Utils.getDatosTestCase("producto1")["productoExistente"]);//Se selecciona solo el producto existente y se guarda
            
            productoCondition.Resultado_Agregar_Producto_tipo_circuito_de_capacidad();//se realizan comprobaciones

            //Paso 6
            productoActions.Agregar_Linea_de_negocio_y_Unidad_de_venta(Utils.getDatosTestCase("producto1"));
        ...
        public void CRM_APR0004_Producto_Añadir_FibraOscura()
        {
            ...
            ofertaActions.BuscarOfertaEnVista(Utils.getDatosTestCase("oferta")["nombreOferta"] + Oferta.getFechaHoraActual());
        ...
        [AllureSubSuite("PRO AÑADIR PRODUCTO")]
        public void CRM_APR0007_Producto_Añadir_Rack_Colocation()
        {
            // Login y Acceso a Gestión de Cliente
            commonActions.acceder_A_GestionCliente();
            commonCondition.validar_Acceso_A_GestionCliente();
        ...
        public void CRM_APR0008_Producto_Cambio_de_Capacidad_CC()
        {
            ...
            //Paso 5
            productoActions.Cumplimentar_campos_y_guardar(Utils.getDatosTestCase("producto1"));            
        ...
        public void CRM_APR0009_Producto_heredar_CC_CambioPrecio()
        {
            ...
            productoActions.HeredarProducto(Utils.getDatosTestCase("heredarProducto"));
        ...
        //CRM-APR0017
        [Test(Description = "CRM-APR0016 Heredar producto UbiRed Pro en Oferta Cambio de Precio")]
        [AllureSubSuite("PRO AÑADIR PRODUCTO")]
        public void CRM_APR0016_Producto_heredar_UbiRedPro_CambioPrecio()
        {
            // Login y Acceso a Gestión de Cliente
            commonActions.acceder_A_GestionCliente();
            commonCondition.validar_Acceso_A_GestionCliente();
        ...
        //CRM-APR0018
        [Test(Description = "CRM-APR0017 Heredar producto UbiRed Pro en Oferta Cambio de Titular")]
        [AllureSubSuite("PRO AÑADIR PRODUCTO")]
        public void CRM_APR0017_Producto_heredar_UbiRedPro_CambioTitular()
        {
            // Login y Acceso a Gestión de Cliente
            commonActions.acceder_A_GestionCliente();
            commonCondition.validar_Acceso_A_GestionCliente();
            ...
            // TODO: Añadir Producto a la Oferta UbiRed Pro
            productoActions.HeredarProducto(Utils.getDatosTestCase("heredarProducto"));
